...
public class Buildings {
    ...
    private void findBuilding(double x, double y) {
        ...
        //try which building
        while (true) {
            if (contains(x, y, LibraryCoords)) {
                this.BuildingName = "Monsignor William Barry Memorial Library";
                break;
            } else if (contains(x, y, GarnerCoords)) {
                this.BuildingName = "Garner Hall";
                break;
            } else if (contains(x, y, LandonCoords)) {
                this.BuildingName = "R.Kirk Landon Student Union";
                break;
            } else {
                break;
            }
